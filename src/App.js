  ...
  return (
    <Container>
      <Row>
        ...
        <Col>
        <Media>
          <h4><img width='32'src='https://banner2.kisspng.com/20180420/kuq/kisspng-computer-icons-user-clip-art-my-vector-5ad9a348cd2ce1.8035052415242125528404.jpg'/>
          Andreas</h4>
        </Media>
        </Col>
      </Row>
          ...
          <CardGroup>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                Saint-Germain soal perpanjangan kontrak bersama kampiun Ligue 1
            ...
            <Card>
              ...
              <Card.Body>
                ...
                Barkley sangat optimistis. Ross Barkley merasa Inggris sudah
                berada di jalur yang benar untuk menjadi tim terbaik di dunia
            ...
            <Card>
              ...
              <Card.Body>
                ...
                Gelandang tim nasional (timnas) Indonesia U-23, Sani Rizki Fauzi
                menegaskan kesiapannya untuk bermain pada laga melawan Brunei
                Darussalam U-23. Kedua tim akan bentrik pada laga pamungkas grup K
                <p><Button variant='primary'>Read More</Button></p>
              </Card.Body>
            </Card>
          </CardGroup>
